...
const PreviousWeeklyTracker = () => {
  ...
  return (
    <div style={{ textAlign: 'center' }}>
      <h3 style={{ color: '#C5C6C7', fontSize: '12px', paddingBottom: "1vh", paddingTop:"0.5vh", paddingRight: "0.5vw" }}>Last Week</h3>
...
export default PreviousWeeklyTracker;
